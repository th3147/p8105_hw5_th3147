...
- The raw data had 52179 observations and 12 columns.
...
```
    ...
    ## # A tibble: 1 × 6
    ##   city_state total_homicides homicides_unsolved prop_estimate conf_low conf_high
    ##   <chr>                <int>              <int>         <dbl>    <dbl>     <dbl>
    ## 1 Baltimore…            2827               1825         0.646    0.628     0.663
